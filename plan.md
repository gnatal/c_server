...
- **Large architectural items** (#2, #7, #8, #11): #2 (Streaming & chunked responses) and #7 (Linux `epoll` portability) are Done! Only #8 (multi-worker concurrency) and #11 (TLS/HTTPS) remain.
