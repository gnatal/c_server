...
- `test_http_parser.c`: Pure buffer parsing of HTTP/1.1 request lines, query-string splitting (`parse_query_string`) and lookup (`req_get_query`), header scanning, Content-Length bounds enforcement, and keep-alive header determination.
